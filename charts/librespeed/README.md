...
| `dbHostname`                       | Default database hostname. Required if dbType is `mysql` or `postresql` | ``                        |
| `dbUsername`                       | Default database username. Required if dbType is `mysql` or `postresql` | ``                        |
| `dbPassword`                       | Default database password. Required if dbType is `mysql` or `postresql` | ``                        |
